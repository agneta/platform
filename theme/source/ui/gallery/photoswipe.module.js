...
module.exports = function(options) {
  var gallerySelector = options.selector;
  var swiper = options.swiper;

  var parseThumbnailElements = function(el) {
    var thumbElements = el.querySelectorAll('[ui-gallery-item]');
    ...
    for (var i = 0; i < numNodes; i++) {
      ...
      size = linkEl.getAttribute('data-size') || '1000x1000';
      size = size.split('x');
      item.w = parseInt(size[0], 10) || 1000;
      item.h = parseInt(size[1], 10) || 1000;
      // create slide object
      ...
      if (linkEl.children.length > 0) {
        ...
        item.msrc = linkEl.children[0].getAttribute(options.src || 'src');
      }
